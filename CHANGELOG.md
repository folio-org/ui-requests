...
## [1.14.4](https://github.com/folio-org/ui-requests/tree/v1.14.4) (2020-02-05)
[Full Changelog](https://github.com/folio-org/ui-requests/compare/v1.14.3...v1.14.4)
...
* Retrieve request by id instead of barcode, which may not be present. Refs UIREQ-377.
...
* Show correct value for delivery address. Refs UIREQ-380.
