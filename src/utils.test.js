...
describe('computeUserDisplayForRequest', () => {
  ...
  describe.each([
    ...
    let display;
    beforeAll(() => {
      display = computeUserDisplayForRequest(request);
    });
    it.each([
      'requesterName',
      'requesterBarcode',
...
describe('generateRequestSearchCqlString', () => {
  it('should generate CQL string with default placeholder', () => {
  ...
  it('should generate CQL string with custom term', () => {
  ...
  it('should include wildcards for fields that require *', () => {
    const result = generateRequestSearchCqlString('abc');
  ...
  it('should not include wildcards for fields that do not require *', () => {
    const result = generateRequestSearchCqlString('abc');
  ...
  it('should return a string wrapped in parentheses', () => {
    const result = generateRequestSearchCqlString('foo');
